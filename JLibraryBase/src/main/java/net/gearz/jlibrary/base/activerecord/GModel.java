...
public abstract class GModel {
    ...
    /**
     * Loads a GModel from an existing {@link com.mongodb.DBObject} in a Database
     *
     * @param database The database to reference for linked objects.
     * @param dBobject The {@link com.mongodb.DBObject} to load data from.
     */
    ...
    /**
     * Processes a list into a {@link com.mongodb.BasicDBList}
     *
     * @param l The {@link java.util.List} object
     * @return The {@link com.mongodb.BasicDBList} object.
     */
    ...
    public void remove() {
        ...
        this.collection.remove(
                new BasicDBObject("_id", this.objectId)
        );
    }
}